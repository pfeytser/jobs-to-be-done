            ...
            return (
              <div
                ...
                className={`p-5 rounded-lg border-2 ${
                  guessed ? 'border-ink bg-accent/20' : 'border-line bg-surface/60'
                }`}
              >
                <div className="flex items-start gap-3">
                  <span className="shrink-0 w-7 h-7 rounded-full grid place-items-center text-sm font-black bg-canvas text-ink-muted border border-line">
