      ...
      {!anyGenerated && cards.length > 0 && (
        <div className="text-center py-16 space-y-3">
          <div className="flex justify-center">
            <svg className="w-7 h-7 animate-spin text-ink-muted" fill="none" viewBox="0 0 24 24">
          ...
          {stuckSeconds >= 20 ? (
            ...
            <p className="text-xs text-ink-muted">Your facilitator is setting up the brainstorm</p>
          )}
        </div>
      )}
            ...
            >
              ...
              <div className="px-5 pt-5 pb-4">
                ...
                {card.problemStatement ? (
                  <p className="mt-2 text-sm text-ink-soft leading-relaxed italic">
                    {card.problemStatement}
                  </p>
                ) : (
